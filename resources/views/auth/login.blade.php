        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post" action="{{route('login')}}">
              ...
              <h1>Login Form</h1>
              <div>
                <input type="email" id="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email" 
                name="email" required="" />
                  @if ($errors->has('email'))
              ...
              <div>
                <input type="password" id="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Password"
              ...
              <div>
                <button class="btn btn-default submit">Log in</button>
                 ...
                 @if (Route::has('password.request'))
                      <a class="breset_pass" href="{{ route('password.request') }}">
