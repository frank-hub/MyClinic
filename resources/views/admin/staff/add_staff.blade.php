              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="{{ route('staff.store') }}" novalidate>
                        @csrf
                        ...
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Passpoert Photo<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
